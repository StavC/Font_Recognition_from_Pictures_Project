...
def preprocess():
    ...
    for im_name in im_names:  # going through all the pictures
        ...
        i = 0
        for char in font:  # going through all chars
        ...
        [
            tf.keras.layers.experimental.preprocessing.RandomFlip("horizontal",
                                                                  input_shape=(128,
                                                                               128,
                                                                               1)),
            # tf.keras.layers.experimental.preprocessing.RandomRotation(0.1),#originanlly was 0.1
            tf.keras.layers.experimental.preprocessing.RandomContrast(0.3),  # originanlly was 0.1
            tf.keras.layers.experimental.preprocessing.RandomZoom(0.4),  # originanlly was 0.1
        ]
    )
